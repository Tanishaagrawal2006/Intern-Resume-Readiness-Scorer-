...
try:
    ...
    db = client["InternPortfolioScorer_DB"]
    history_collection = db["analysis_history"]

    print("MongoDB Connected Successfully!")

except Exception as conn_e:
    print(f"MongoDB Connection Failed: {conn_e}")
    ...
    if mode == "single":
        ...
        <div style="flex: 1; border-left: 1px solid rgba(255,255,255,0.1); padding-left: 20px;">
            ...
            <p style="margin: 5px 0;"><strong>GitHub:</strong> 
                ...
                <a href="{r.get('repos', [{}])[0].get('html_url', '#')}" target="_blank" style="color: #3b82f6;">View Profile</a>
            </p>
        </div>
    </div>
</div>
